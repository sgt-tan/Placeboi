...
{	
    ...
    //private PlayerControl playerControl = GameObject.Find("hero").GetComponent<PlayerControl>();
    ...
    public void OnCollisionEnter2D (Collision2D col)
	{
        ...
        else if((col.gameObject.tag == "Enemy" || col.gameObject.tag == "Hazard" || col.gameObject.tag == "EnemyShot" || col.gameObject.tag == "Bossman") && playerControl.dashToggle)
        {
